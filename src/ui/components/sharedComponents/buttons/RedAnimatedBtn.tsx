...
export default function RedAnimatedBtn({ onClick, text, disabled }: { onClick: () => void, text: string, disabled?: boolean }) {
    ...
    return (
        ...
        >
            <div className="bg-red-gradient w-2 px-1 h-15 overflow-hidden rounded-tl-lg rounded-bl-lg"></div>

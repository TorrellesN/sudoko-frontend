...
export default function PvpWinDetails() {
      const {
        comboAcc,
        points,
        completedTime,
    ...
    <div className='container flex flex-col items-center sm:items-end justify-start sm:justify-center mx-auto w-full max-w-screen-xl min-h-screen '>
        <div className=' container px-0.5 sm:px-6 md:px-18 py-12 gap-6 z-5 max-w-2xl'>
          <motion.section
            ...
            <p className="self-start font-medium text-xl">Estadísticas</p>

            <div className="flex flex-col gap-3 p-4 my-6 justify-center items-center aspect-square rounded-lg
            bg-[var(--primary-text)] text-[var(--base-100)]
            ">
              <p className="italic text-xs self-start pb-2 ml-1">Has obtenido:</p>
              <p className="text-6xl font-bold">{sudokoins}</p>
